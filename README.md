...
* Copy and paste the following command: `wget -qO- https://github.com/bolemo/firewall-blocklist/archive/v1.5.2.tar.gz | tar xzf - --one-top-level=fbl --strip-components 1`
